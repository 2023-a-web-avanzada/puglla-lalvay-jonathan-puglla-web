...
// devolver el índice del primer elemento que cumpla esa condición

const respuestaFindIndex = arreglo
    .findIndex(
        function (varlorActual) {
            return varlorActual.nota < 5; // Expresión (< =)
        }
    );
console.log('respuestaFindIndex', respuestaFindIndex); // Si encuentra el índice, sino -1
